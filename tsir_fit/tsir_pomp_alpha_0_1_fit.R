library(dplyr)
library(pomp)
source("../R/fitfun_pomp_sir_alpha.R")
...
fn <- paste0("tsir_pomp_alpha_0_1_fit_", batch_num, ".rda")
...
for (i in 1:nsim) {
	...
	start <- c(beta=1.5, rho=0.7, I0=1e-4, disp=40, alpha=0.97)
	
	rwsd_arg <- list(beta=0.05, rho=0.05, I0=0.05, disp=0.05, alpha=0.05)

...
While regression-based methods can be useful for exploratory analyses, we suggest that Monte Carlo methods, coupled with rigorous model validation through simulations, should be used for any final analyses of epidemic time series.
...
Rigorous model checking will help scientists make better inference about epidemic processes.

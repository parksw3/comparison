...
london_pomp_exp_det_exp_frequency_list <- vector('list', 100)
...
save("trans.param", "london_pomp_exp_det_exp_frequency_list", "ld_pomp_arg", 
	 file="london_pomp_exp_det_exp_frequency.rda")

...
london_pomp_tsir_det_fixed_frequency_list <- vector('list', 100)
...
for (i in 1:100) {
	...
	london_pomp_tsir_det_fixed_frequency_list[[i]] <- list(mle=m, ll=ll)
}

save("trans.param", "london_pomp_tsir_det_fixed_frequency_list", "ld_pomp_arg", 
	 file="london_pomp_tsir_det_fixed_frequency.rda")
